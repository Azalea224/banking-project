...
const calculateAchievements = (
  ...
  achievements.push({
    ...
    icon: require("../assets/Getting Started.png"),
  ...
  achievements.push({
    ...
    icon: require("../assets/Social Butterfly.png"),
  ...
  achievements.push({
    ...
    icon: require("../assets/Power User.png"),
  ...
  achievements.push({
    ...
    icon: require("../assets/Transaction Master.png"),
  ...
  achievements.push({
    ...
    icon: require("../assets/Money Maker.png"),
    unlocked: deposits >= 1,
  ...
  achievements.push({
    ...
    icon: require("../assets/Sharing is Caring.png"),
  ...
  achievements.push({
    ...
    icon: require("../assets/Centurion.png"),
  ...
  achievements.push({
    ...
    icon: require("../assets/Thousandaire.png"),
  ...
  achievements.push({
    ...
    icon: require("../assets/High Roller.png"),
